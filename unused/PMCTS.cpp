// Works, but does not seem to improve performance during training. 
// Also, during playing, single-thread asynchronoous version seems to work almost equally well.
