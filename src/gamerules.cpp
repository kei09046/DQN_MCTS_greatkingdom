...
Game::Game() : moveCount(0), possibleMoves(), pTransferGroups(boardSize + 1, -1){
    uint8_t temp = 0;
...
const std::vector<int>& Game::getAvailableMoves() const{
    return possibleMoves;
} 

const std::vector<int>& Game::getTransferTable() const{
