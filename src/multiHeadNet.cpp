...
// 	register_module("sc_cv3", v_cv3);
// 	register_module("sc_bn3", v_bn3);
// 	register_module("sc_fc1", v_fc1);
// 	register_module("sc_fc2", v_fc2);
// }
...
// 	return std::make_tuple(log_act, val, score);
// }
...
//     torch::Tensor wb = torch::from_blob(result_batch.data(), { globalConfig.batchSize }, options).to(device);
